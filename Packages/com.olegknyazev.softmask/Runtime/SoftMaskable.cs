    ...
    public class SoftMaskable : UIBehaviour, IMaterialModifier
    {
        ...
        public Material GetModifiedMaterial(Material baseMaterial)
        {
            if (isMaskingEnabled)
            {
                ...
                // 首先获取一个新的材质，然后释放旧材质，如果旧材质仍然有效，我们可以重用它。
                ...
                // SoftMask's business.
                // 仅当材质使用非默认的UI Shader时警告。否则，替换似乎为空，因为SoftMask.defaultShader
                // 还没有设置。如果是那就是SoftMask的问题。
